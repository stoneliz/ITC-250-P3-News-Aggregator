...
//Sessions currently stored in db via session_db_inc.php
...
define('VIRTUAL_PATH', 'http://www.lizstonesthrow.com/wn17/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/lizsto2/lizstonesthrow.com/wn17/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'stoneliz@hotmail.com'); # Email of site support
...
$nav1['news/'] = "News~The haps in the world of entertainment";
